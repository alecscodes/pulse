...
import { create, index as monitorsIndex, show } from '@/routes/monitors';
                        ...
                        <div v-else class="space-y-3">
                            ...
                            >
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <Badge
                                        :variant="
                                            getMonitorStatus(monitor).variant
                                        "
                                        class="text-xs"
                                    >
                ...
                <Card v-if="props.downWebsites.length > 0">
                    ...
                    <CardContent>
                        <div class="space-y-2">
                            ...
                            >
                                <Link :href="show(website.id)" class="flex-1">
                                    <div class="font-medium">
                                        {{ website.name }}
                                    </div>
