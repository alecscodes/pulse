...
import { destroy, edit, index as monitorsIndex, show } from '@/routes/monitors';
...
defineOptions({
    layout: (layoutProps: Props) => ({
        breadcrumbs: [
            ...
            {
                title: layoutProps.monitor.name,
                href: show(layoutProps.monitor.id),
            },
        ],
    }),
});
...
function deleteMonitor(): void {
    if (confirm('Are you sure you want to delete this monitor?')) {
        router.delete(destroy.url(props.monitor.id));
    }
}
...
const actionSheetButtons = computed(() => [
    {
        ...
        handler: () => {
            ...
            router.visit(edit.url(props.monitor.id));
        },
    },
    {
        text: 'Delete Monitor',
    ...
    >
            ...
            <Card class="self-start">
                ...
                <CardContent class="space-y-2 text-sm">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium">{{ monitor.method }}</span>
                    </div>
                    <div class="flex justify-between">
        ...
        <Card>
            <CardHeader>
                ...
                >
                <CardDescription
                    >Past incidents when the monitor was down</CardDescription
                >
            </CardHeader>
            <CardContent>
                <div
                    v-if="!monitor.downtimes || monitor.downtimes.length === 0"
