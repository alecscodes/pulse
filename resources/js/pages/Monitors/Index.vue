    ...
    return [
        {
            ...
            handler: () => {
                showActionSheet.value = false;
                router.visit(show.url(actionSheetMonitor.value!.id));
            },
        },
        {
            text: 'Edit Monitor',
            ...
            handler: () => {
                showActionSheet.value = false;
                router.visit(edit.url(actionSheetMonitor.value!.id));
            },
        },
        {
            text: 'Delete Monitor',
    ...
    >
            ...
            <Card v-for="monitor in monitors" :key="monitor.id">
                ...
                <CardContent>
                    ...
                    <div class="mt-4 hidden gap-2 md:flex">
                        <Link :href="show(monitor.id)" class="flex-1">
                            <Button variant="outline" class="w-full"
                                >View</Button
                            >
                        </Link>
                        <Link :href="edit(monitor.id)" class="flex-1">
                            <Button variant="outline" class="w-full"
                                >Edit</Button
                            >
                        </Link>
        ...
        <ActionSheetRoot v-model:open="showActionSheet">
            <ActionSheet
                ...
                :header="
                    actionSheetMonitor ? actionSheetMonitor.name : 'Monitors'
                "
